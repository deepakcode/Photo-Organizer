...
// This filters out all the videos from any folder recursively and organizes them by year
public class VideoOrganizerYearWise {

    public static void main(String[] args) {
        String sourceDirectory = "/Users/deepakvishwakarma/deepak-drive-e/All_Videos";
                ...
                if (!file.toFile().getName().endsWith(".DS_Store")) {
                    if (isVideo(file)) {
                        ...
                        if (creationDate != null) {
                            moveFile(file, videoDestination, creationDate);
                        }
                    }
                }
    ...
    private static void moveFile(Path file, String videoDestination, Date creationDate) throws IOException {
        String year = new SimpleDateFormat("yyyy").format(creationDate);
        Path destinationDirectory = Paths.get(videoDestination, year);
